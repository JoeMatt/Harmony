...
@objcMembers
@objc public final class HarmonyExample_iOS: NSObject {
	public class var resources: Bundle {
		#if FRAMEWORK
			let bundle = Bundle(for: HarmonyExample_iOS.self)
		#elseif SWIFT_PACKAGE
			let bundle = Bundle.module
		#elseif STATIC_LIBRARY
			let bundle: Bundle
			if let bundleURL = Bundle.main.url(forResource: "HarmonyExample_iOS", withExtension: "bundle") {
